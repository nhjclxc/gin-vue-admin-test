...
func (i *initUser) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	password := utils.BcryptHash(apStr)      //$2a$10$GjylQVrrKfUEllCaewg.4u1C.hssO9l2H.dvtYjGION55kDl1Lif6
	adminPassword := utils.BcryptHash(apStr) //$2a$10$V.zlfZCgx9XQVCIEjZDs8OHqU4g5kaJ/V9J64CqvNYfLUUjRHfNOq

	entities := []sysModel.SysUser{
		{
			UUID:        uuid.New(), //422ea638-7c53-4c7c-8b02-e2c869943723
			Username:    "admin",
		...
		{
			UUID:        uuid.New(), //cb911fd9-ae65-42fc-8c4a-81d15c077094
			Username:    "a303176530",
			Password:    password,
			NickName:    "用户1",
